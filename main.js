...
document.addEventListener('DOMContentLoaded', () => {
  const paths = document.querySelectorAll('.cls-1, .cls-2');

  paths.forEach(path => {
    const length = animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"].setDashoffset(path);
